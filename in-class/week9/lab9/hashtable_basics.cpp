...
struct HashTable{
	...
	//add an if condition to complete the code here
         if (isFull()){
            cout << "Unable to insert user: Hashtable is full." << endl;
            return;
        }
        if(!empty){
            cout << "Collision detected: Unable to insert user '" << user_name << "'." << endl;
            return ;
        }
        password[hash] = user_password;
        cout << "User '" << user_name << "' successfully inserted." << endl;
	...
	//add an if condition to complete the code here
        if (empty){
            cout << "Data not in hash table." << endl;
            return;
        }
